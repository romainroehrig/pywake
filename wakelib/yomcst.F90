...
! * REPSM        : polar axis tilting angle (known as Obliquity)
! * RSIYEA       : duration of the sideral year
! * RSIDAY       : duration of the sideral day
! * ROMEGA       : angular velocity of the Earth rotation
! * REXC         : Earth orbital excentricity
! * RPERW        : Earth orbital perihelie longitude (rad)
! * REOM         : Mean Earth orbital angular speed around the Sun(rad.yr-1)
! * RDAYSOX      : Day of the spring equinox
REAL(KIND=JPRB) :: RDAY
REAL(KIND=JPRB) :: REA
...
REAL(KIND=JPRB) :: REXC
REAL(KIND=JPRB) :: RPERW
REAL(KIND=JPRB) :: REOM
REAL(KIND=JPRB) :: RDAYSOX
...
! * RMCFC11      : CFC-11 molar mass
! * RMCFC12      : CFC-12 molar mass
REAL(KIND=JPRB) :: R
REAL(KIND=JPRB) :: RMD
REAL(KIND=JPRB) :: RMV
REAL(KIND=JPRB) :: RMO3
